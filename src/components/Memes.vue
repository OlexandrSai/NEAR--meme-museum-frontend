<template>
    ...
    <section class="relative">
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-center">
                
                <!-- Meme card -->
                <div 
                    v-for="meme in memes"
                    :key="meme"
                    class="w-251 my-16 mx-auto">

                    <div class="block w-251 h-244 overflow-hidden rounded-md">
                        <img 
                            :src="meme.image" 
                            :alt="meme.info.title" 
                            class="w-full h-full card-shadow transform hover:scale-105 duration-200">
                    </div>

                    <!-- Meme name - data -->
                    <div class="flex flex-col justify-between items-baseline mt-5">
                    ...
                    <!-- Owner -->
                    <p class="text-gray-900 text-xs mt-2 font-medium">{{ meme.id }}.{{ contractId }}.testnet</p>
